...
sol_odeint_z = odeintegrator_z([-10, 0.9, 0.4, 0., 0, 0, 0, 0, 0.8, 0])
...
sol_odeint_w = odeintegrator_z([-10, 0.4, 0.4, 0., 0, 0, 0, 0, 0., 0])
...
for j in range(20,len(t),2):
    ...
    fig3.savefig(f"./video/convert/premik1_{1000+j}.png")